...
namespace Otomasyon_Ödev
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            ogrenciTablosu.Columns.Add("Ders Adı / Ders Kodu", typeof(string));
        ...
        public bool akaEkle()
        {
            danısman akademısyen = new danısman(txt_ders.Text, txt_bolum.Text);
            danısman.Add(akademısyen);
            return true;
        }
        public bool akaKontrol()
        {
            if (!string.IsNullOrEmpty(txt_ders.Text) && !string.IsNullOrEmpty(txt_bolum.Text))
            {
                return true;
            }
            else
        ...
        private void btn_aekle_Click(object sender, EventArgs e)
        {
            ...
            if (txt_ders.Text.Length > 0 && txt_bolum.Text.Length > 0)
            {
                cmbox_danısman.Items.Add(txt_ders.Text + "  " + txt_bolum.Text);
                MessageBox.Show("Kaydınız Oluşturuldu.");
            }
            else
            {
